...
/*
    ...
    */
    var mrn,csn, pat_ln, pat_fn, gender,dob,pr_id,pr_ln,pr_fn,doc_type,epic_doc_cmt, service_dt,doc_sign_dt,img_path,img_fn, image_fn string
    var line_count,file_count  int = 0,1 
    if file_type == "image"  { 
        ...
        if err != nil {
            ...
            if _,ok := demo_data[mrn]; ok {   
                ...
                var items []string
                items = append(items, mrn,csn,pat_ln,pat_fn,dob,gender,pr_id,pr_ln,pr_fn,doc_type,epic_doc_cmt,service_dt,doc_sign_dt,image_fn) 
            ...
            //    fmt.Println(line) 
                ...
                } else if (line_count <= lines_per_file) { 
                    file_name :="index"+ strconv.Itoa(file_count) +".txt"  
                    f, err := os.OpenFile(file_name, os.O_CREATE|os.O_APPEND|os.O_WRONLY, 0777)
                    if err != nil { 
                        panic(err)         
                    } 
            ...
            if _,ok := demo_data[mrn]; ok {   
                ...
                */
                ...
                if lines_per_file == -1 {
                    ...
                    file_name :="index_visit"+ strconv.Itoa(file_count) +".txt"  
                    f, err := os.OpenFile(file_name, os.O_CREATE|os.O_APPEND|os.O_WRONLY, 0777)
                    if err != nil { 
                        panic(err)         
                    } 
